...
package com.pradeep.stockapp.custom_components;
...
public class SimpleListDividerDecorator extends RecyclerView.ItemDecoration {
    ...
    public SimpleListDividerDecorator(@Nullable Drawable horizontalDivider, @Nullable Drawable verticalDivider, boolean overlap) {
        ...
        Log.i("Myapp","Height "+mHorizontalDividerHeight);
    ...
    public void xyz(Canvas canvas,int height,int width)
    {
        Path mPath;
        mPath = new Path();
        mPath.moveTo(0, height / 2);
        mPath.quadTo(width/2, height/2, width, height/2);
